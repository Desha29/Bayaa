...
class AppColors {
  // 👑 Brand Gold (from AMR Mobile logo)
  ...
  // 🖤 Premium Black (from logo background) - Kept as secondary/accent if needed
  static const Color secondaryColor = Color(0xFF000000);

  // ☀️ Light Luxury Surfaces
  ...
  // ✍️ Text / UI (Dark for readability on White)
