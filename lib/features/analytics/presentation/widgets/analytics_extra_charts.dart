          ...
          children: [
            Row(
              children: [
                 ...
                 Text(l10n.salesByHour, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.kDarkChip)),
              ],
            ),
                  ...
                  barTouchData: BarTouchData(
                    touchTooltipData: BarTouchTooltipData(
                      ...
                      getTooltipItem: (group, groupIndex, rod, rodIndex) {
                        final hour = group.x;
                        final period = hour < 12 ? l10n.amPeriod : l10n.pmPeriod;
          ...
          children: [
            Row(
              children: [
                 ...
                 const SizedBox(width: 12),
                 Text(l10n.salesByDepartment, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.kDarkChip)),
              ],
            ),
             const SizedBox(height: 24),
          ...
          children: [
            Row(
              children: [
                 ...
                 const SizedBox(width: 12),
                 Text(l10n.refundRatio, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.kDarkChip)),
              ],
            ),
            const SizedBox(height: 24),
            SizedBox(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                         _LegendItem(color: AppColors.successColor, text: l10n.netSalesLabel(netSales.toStringAsFixed(0))),
                         const SizedBox(height: 8),
                         _LegendItem(color: AppColors.errorColor, text: l10n.refundsLabel(widget.refunds.toStringAsFixed(0))),
                      ],
                    ),
                  )
                ],
