...
class _InvoiceScreenState extends State<InvoiceScreen>
  ...
  Future<void> _handleReturnSale(Sale sale) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.of(context).refundSuccess)),
      );
    }
  }
  ...
  Future<void> _deleteInvoices(
    ...
    if (startDate == null || endDate == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l10n.selectDateRangeToDelete),
          backgroundColor: AppColors.errorColor,
        ),
      );
      return;
  ...
  Future<void> _openInvoice(Sale sale) async {
    ...
    final cashierName = sale.cashierName ?? AppLocalizations.of(context).cashier;
                    ...
                    FadeTransition(
                      ...
                      child: SlideTransition(
                        ...
                        child: ScreenHeader(
                          ...
                          subtitle: l10n.invoicesScreenSubtitle,
