...
class ProductDetailsDialog extends StatelessWidget {
                    ...
                    child: Theme(
                      ...
                      child: DataTable(
                        ...
                        columns: [
                          ...
                          DataColumn(label: Text(l10n.refunds), numeric: true),
  ...
  Widget _buildSummaryChip(AppLocalizations l10n, String label, int value, Color color, IconData icon) {
    return Expanded(
      child: Container(
